# Project Status - Constitutional AI Framework v1.0.0
...
Since we don't have GitHub CLI (`gh`) installed, the following must be done manually through GitHub's web interface:
...
### 4. Update README Quick Links (2 minutes)
